...
if page == pages[2]:
    ...
    old_data = pd.read_csv("weatherAUS.csv")
    to_drop = ["Temp9am", "Temp3pm", "WindDir9am", "WindDir3pm", "WindSpeed9am", "WindSpeed3pm", "Cloud9am", "Cloud3pm"]
    old_data = old_data.drop(to_drop, axis=1)
    ...
    old_data=pd.read_csv("WeatherAUSFinal.csv",sep=";")
